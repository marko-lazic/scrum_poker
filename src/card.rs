...
pub fn Card(cx: Scope<CardProps>) -> Element {
    cx.render(rsx! {
        button { class: "select-none p-1 relative sm:w-10 md:w-20 sm:h-14 md:h-28 mx-auto bg-white hover:bg-slate-100 focus:bg-slate-400 rounded-xl shadow-lg text-2xl md:text-3xl text-slate-500 focus:text-slate-50",
            span {
